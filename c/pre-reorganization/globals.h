...
unsigned char menu_char_x=0;
unsigned char menu_char_y=0;
unsigned char menu_skills_x=0;
unsigned char menu_skills_y=0;
unsigned char menu_res_x=0;
unsigned char menu_res_y=0;
...
//unsigned int rand_val=1; //Too many rocks around starting position
unsigned int rand_val=32;	//Decent looking map with this seed
