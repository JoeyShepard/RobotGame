...
(
			create skill_texts
s"
20% chance that$mining won't$consume energy         
10% chance of$mineral when$you kill an$enemy        
-2 Mine and$Drill time                              
25% chance of$mineral when$mining rock              
Mine double$minerals                                
+20% chance of$critical hit                         
Crit damage$raised from$150% to 200%                
+10% bonus to$experience on$kill                    
5% chance to$kill enemy in$one hit                  
Walk through$enemies                                
20% chance that$crafting will$cost nothing          
+5 random$mineral when$leveling up                  
-1 to cost of$items                                 
10% chance$that crafted$items will be$yellow quality
Pay with any$crystal                                
" 2drop
)			
