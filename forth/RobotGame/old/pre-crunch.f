...
\ Variables stored in zero page
	...
	8C constant no_print					\ flag to suppress output while loading

\ Hardware 
	FFE1 constant bank2_register			\ 0x4000-0x7FFF
	FFE2 constant bank3_register			\ 0x8000=0xBFFF
	1 constant bank_gen_ram2				\ banked code goes here (bank 2)
	\ 2 constant bank_gen_ram3
	4 constant bank_gfx_ram1				\ upper half of screen (bank 2)
	\ 5 constant bank_gfx_ram2
	100 constant SCREEN_WIDTH
	80 constant SCREEN_HEIGHT
	4000 constant SCREEN_ADDRESS
...
\ Game constants
	...
	DictBankROM								
		...
		28 lit_const MAP_WIDTH
		14 lit_const MAP_HEIGHT
			
		60 lit_const LEGEND_WIDTH 
		80 lit_const LEGEND_HEIGHT 
		A0 lit_const LEGEND_LEFT 
		0 lit_const LEGEND_TOP 

		5 lit_const FRAME_WIDTH 
		4 lit_const FRAME_HEIGHT 

		0 lit_const DIRECTION_NONE 
		1 lit_const DIRECTION_UP 
		2 lit_const DIRECTION_DOWN 
		3 lit_const DIRECTION_LEFT 
		4 lit_const DIRECTION_RIGHT 

		0 lit_const OUTPUT_GAME 
		1 lit_const OUTPUT_CHARACTER 
		2 lit_const OUTPUT_SKILLS 
		3 lit_const OUTPUT_RESOURCES 
		4 lit_const OUTPUT_GAME_OVER 
			
		14 lit_const MAP_LAVA_COUNT 
		3C lit_const MAP_WALL_COUNT 
		5 lit_const MAP_LAVA_SIZE 
		5 lit_const MAP_WALL_SIZE 
		0 lit_const MAP_BLANK 
		1 lit_const MAP_BLANK_90 
		2 lit_const MAP_BLANK_180 
		3 lit_const MAP_BLANK_270 
		4 lit_const MAP_ROCK 
		5 lit_const MAP_LAVA 
		6 lit_const MAP_EXIT 

		1 lit_const HERO_START_X 
		1 lit_const HERO_START_Y 

		1E lit_const BOT_HP 

		0 lit_const SKILL_BATTERY_SAVER 
		1 lit_const SKILL_BOUNTY_HUNTER 
		2 lit_const SKILL_FAST_DIGGER 
		3 lit_const SKILL_LUCKY_DRILLER 
		4 lit_const SKILL_MASTER_MINER 
		5 lit_const SKILL_LUCKY_CRIT 
		6 lit_const SKILL_CRIT_LORD 
		7 lit_const SKILL_EXPERIENCED 
		8 lit_const SKILL_INSTAKILL 
		9 lit_const SKILL_GHOST 
		A lit_const SKILL_FREE_LUNCH 
		B lit_const SKILL_WISE_REWARDS 
		C lit_const SKILL_BIG_DISCOUNT 
		D lit_const SKILL_ONLY_THE_BEST 
		E lit_const SKILL_CRYSTALSMITH 
		F lit_const SKILL_COUNT 


		0 lit_const COLOR_BLACK 
		3F lit_const COLOR_WHITE 
		C lit_const COLOR_GREEN 
		3 lit_const COLOR_RED 
		2 lit_const COLOR_DARK_RED 
		30 lit_const COLOR_BLUE 
		20 lit_const COLOR_DARK_BLUE 
		8 lit_const COLOR_DARK_GREEN 
		32 lit_const COLOR_PURPLE 
		21 lit_const COLOR_DARK_PURPLE 
		B lit_const COLOR_ORANGE 
		6 lit_const COLOR_DARK_ORANGE 
		F lit_const COLOR_YELLOW 
		A lit_const COLOR_DARK_YELLOW 
		15 lit_const COLOR_GRAY_1 
		2A lit_const COLOR_GRAY_2 
		40 lit_const COLOR_TRANSPARENT 

		15 lit_const COLOR_LEGEND_BG 
		21 lit_const COLOR_ROCK 
		3B lit_const COLOR_DIRT 
		B lit_const COLOR_LAVA 
		17 lit_const COLOR_CRYSTAL_RED1 
		2B lit_const COLOR_CRYSTAL_RED2 
		1F lit_const COLOR_CRYSTAL_YELLOW1 
		2F lit_const COLOR_CRYSTAL_YELLOW2 
		35 lit_const COLOR_CRYSTAL_BLUE1 
		3A lit_const COLOR_CRYSTAL_BLUE2 
		35 lit_const COLOR_EXIT 
		1 lit_const COLOR_MONSTER 

		3 lit_const COLOR_HP 
		30 lit_const COLOR_BATT 
		1 lit_const COLOR_DMG 
		1 lit_const COLOR_CRIT 
		17 lit_const COLOR_MINE 
		32 lit_const COLOR_DRILL 
		B lit_const COLOR_LAVA_RES 

		8 lit_const COLOR_MENU_CHAR 
		20 lit_const COLOR_MENU_SKILLS 
		2 lit_const COLOR_MENU_RESOURCES 
		2A lit_const COLOR_MENU_BORDER 

		1E lit_const INVENTORY_COUNT 
		8 lit_const TEXT_LINE_HEIGHT 
		6 lit_const TEXT_CHAR_WIDTH 
		A lit_const TEXT_SPACING_Y 
		28 lit_const MONSTER_COUNT 
		A lit_const MONSTER_HP 
		28 lit_const CRYSTAL_COUNT 
		50 lit_const BAR_WIDTH 
		6 lit_const BAR_HEIGHT 
		54 lit_const LEGEND_MAZE_TOP 
		8 lit_const LEGEND_MAZE_LEFT 
		3 lit_const LEGEND_MAZE_MONSTER_COLOR 
		F lit_const LEGEND_MAZE_CRYSTAL_COLOR 
		A lit_const LEGEND_BOX_WIDTH 
		8 lit_const LEGEND_BOX_HEIGHT 
		8 lit_const LEGEND_STATS_LEFT 
		4 lit_const LEGEND_HP_TOP 
		D lit_const LEGEND_HP_BAR_TOP 
		18 lit_const LEGEND_BATT_TOP 
		21 lit_const LEGEND_BATT_BAR_TOP 
		2C lit_const LEGEND_EXP_TOP 
		35 lit_const LEGEND_EXP_BAR_TOP 
		40 lit_const LEGEND_TARGET_TOP 
		49 lit_const LEGEND_TARGET_BAR_TOP 
		2 lit_const DRAWITEM_RES_LEFT 
		2 lit_const DRAWITEM_RES_TOP 
		12 lit_const DRAWITEM_ITEM_LEFT 
		4 lit_const DRAWITEM_ITEM_TOP 
		F lit_const DRAWITEM_STAT_TOP 
		A lit_const DRAWITEM_STAT_HEIGHT 
		9 lit_const MENU_CHAR_LEFT 
		9 lit_const MENU_TITLE_TOP 
		4C lit_const MENU_SKILL_LEFT 
		7C lit_const MENU_RES_LEFT 
		9 lit_const MENU_BG_LEFT 
		11 lit_const MENU_BG_TOP 
		EE lit_const MENU_BG_WIDTH 
		66 lit_const MENU_BG_HEIGHT 
		1B lit_const MENU_CHAR_ROBOT_LEFT 
		15 lit_const MENU_CHAR_ROBOT_TOP 
		D lit_const MENU_CHAR_STAT_LEFT 
		38 lit_const MENU_CHAR_HP_TOP 
		41 lit_const MENU_CHAR_BATT_TOP 
		4A lit_const MENU_CHAR_DMG_TOP 
		53 lit_const MENU_CHAR_CRIT_TOP 
		5C lit_const MENU_CHAR_MINE_TOP 
		65 lit_const MENU_CHAR_DRILL_TOP 
		6E lit_const MENU_CHAR_LAVA_TOP 
		4 lit_const MENU_CHAR_BOX_COLOR 
		50 lit_const MENU_CHAR_BOX_LEFT 
		16 lit_const MENU_CHAR_BOX1_TOP 
		46 lit_const MENU_CHAR_BOX2_TOP 
		50 lit_const MENU_CHAR_BOX_WIDTH 
		2D lit_const MENU_CHAR_BOX_HEIGHT 
		12 lit_const MENU_CHAR_BOX_TITLE_OFFSET_X 
		4 lit_const MENU_CHAR_BOX_TITLE_OFFSET_Y 
		12 lit_const MENU_CHAR_BOX_STAT_OFFSET_X 
		F lit_const MENU_CHAR_BOX_STAT_OFFSET_Y 
		A4 lit_const MENU_CHAR_GRID_LEFT 
		14 lit_const MENU_CHAR_GRID_TOP 
		74 lit_const MENU_CHAR_GRID_LINE_TOP 
		50 lit_const MENU_CHAR_GRID_LINE_WIDTH 
		F4 lit_const MENU_CHAR_GRID_LINE_LEFT 
		61 lit_const MENU_CHAR_GRID_LINE_HEIGHT 
		5 lit_const MENU_CHAR_BOX_X_COUNT 
		6 lit_const MENU_CHAR_BOX_Y_COUNT 
		B lit_const MENU_SKILL_POINTS_LEFT 
		14 lit_const MENU_SKILL_POINTS_TOP 
		2E lit_const MENU_SKILL_BOX1_COLOR 
		3A lit_const MENU_SKILL_BOX2_COLOR 
		2B lit_const MENU_SKILL_BOX3_COLOR 
		9 lit_const MENU_SKILL_BOX_LEFT 
		1D lit_const MENU_SKILL_BOX1_TOP 
		3B lit_const MENU_SKILL_BOX2_TOP 
		59 lit_const MENU_SKILL_BOX3_TOP 
		8C lit_const MENU_SKILL_BOX_WIDTH 
		1E lit_const MENU_SKILL_BOX_HEIGHT 
		1C lit_const MENU_SKILL_X_SPACING 
		1E lit_const MENU_SKILL_Y_SPACING 
		B lit_const MENU_SKILL_SKILL_LEFT 
		20 lit_const MENU_SKILL_SKILL_TOP 
		10 lit_const MENU_SKILL_DBOX_COLOR 
		98 lit_const MENU_SKILL_DBOX_LEFT 
		1D lit_const MENU_SKILL_DBOX_TOP 
		5C lit_const MENU_SKILL_DBOX_WIDTH 
		57 lit_const MENU_SKILL_DBOX_HEIGHT 
		9A lit_const MENU_SKILL_DBOX_TEXT_LEFT 
		2B lit_const MENU_SKILL_DBOX_TEXT_TOP 
		1F lit_const MENU_SKILL_DBOX_TITLE_TOP 
		8 lit_const MENU_SKILL_TITLE1_COLOR 
		35 lit_const MENU_SKILL_TITLE2_COLOR 
		17 lit_const MENU_SKILL_TITLE3_COLOR 
		9A lit_const MENU_SKILL_UPGRADE_LEFT 
		6A lit_const MENU_SKILL_UPGRADE_TOP 
		13 lit_const MENU_RES_BLOCK_HEIGHT 
		17 lit_const MENU_RES_BLOCK_WIDTH 
		B lit_const MENU_RES_BLOCK_LEFT 
		13 lit_const MENU_RES_BLOCK_TOP 
		61 lit_const MENU_RES_BLOCK_TOTAL_HEIGHT 
		E lit_const MENU_RES_ITEM_LEFT 
		15 lit_const MENU_RES_ITEM_TOP 
		5C lit_const MENU_RES_BOX_WIDTH 
		57 lit_const MENU_RES_BOX_HEIGHT 
		1 lit_const MENU_RES_BOX_COLOR 
		98 lit_const MENU_RES_BOX_LEFT 
		1D lit_const MENU_RES_BOX_TOP 
		98 lit_const MENU_RES_MONEY_LEFT 
		13 lit_const MENU_RES_MONEY_TOP 
		5C lit_const MENU_RES_MONEY_WIDTH 
		A lit_const MENU_RES_MONEY_HEIGHT 
		15 lit_const MENU_RES_MONEY_VAL_TOP 
		AB lit_const MENU_RES_MONEY_RED_LEFT 
		C3 lit_const MENU_RES_MONEY_BLUE_LEFT 
		DB lit_const MENU_RES_MONEY_YELLOW_LEFT 
		9A lit_const MENU_RES_COST_LEFT 
		6B lit_const MENU_RES_COST_TOP 

		1 lit_const MENU_RES_HP_COLOR1 
		17 lit_const MENU_RES_HP_COLOR2 
		10 lit_const MENU_RES_BATT_COLOR1 
		35 lit_const MENU_RES_BATT_COLOR2 
		5 lit_const MENU_RES_EXP_COLOR1 
		1F lit_const MENU_RES_EXP_COLOR2 

		8 lit_const MENU_BORDER_SIZE 

		2 lit_const HERO_HP_BASE 
		3 lit_const HERO_BATT_BASE 
		8 lit_const HERO_MINE_BASE 
		C lit_const HERO_DRILL_BASE 
		0 lit_const HERO_LAVA_RES_BASE 
		1 lit_const HERO_BATT_RATE_BASE 
		5 lit_const HERO_CRIT_BASE 
		0 lit_const HERO_HP_RECHARGE_BASE 
		4 lit_const HERO_LAVA_DMG_BASE 
		4 lit_const HERO_ATTACK_COST_BASE 
		2 lit_const HERO_MINE_COST_BASE 
		2 lit_const HERO_DRILL_COST_BASE 
		28 lit_const HERO_EXP_MAX_BASE 
		7 lit_const HERO_STAT_COUNT 

		64 lit_const DEAD_LEFT 
		38 lit_const DEAD_TOP 
		37 lit_const DEAD_WIDTH 
		F lit_const DEAD_HEIGHT 
		68 lit_const DEAD_MSG_LEFT 
		3C lit_const DEAD_MSG_TOP 

		FF lit_const NO_MONSTER 
		FF lit_const NO_CRYSTAL 

		0 lit_const CRYSTAL_RED_TYPE 
		1 lit_const CRYSTAL_BLUE_TYPE 
		2 lit_const CRYSTAL_YELLOW_TYPE 	
