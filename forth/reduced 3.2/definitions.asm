...
; User Variables:
.alias user_vars				$80
.alias screen_x					user_vars+0
.alias screen_y					user_vars+1
.alias screen_ptr				user_vars+2
.alias char_ptr					user_vars+4
.alias bank_mode				user_vars+6
.alias cp_main					user_vars+8
.alias cp_banked				user_vars+10
.alias cp_dict_game				user_vars+12
.alias cp_dict_char_menu		user_vars+14
.alias cp_dict_skill_menu		user_vars+16
.alias cp_dict_res_menu			user_vars+18
.alias cp_dict_common_menu		user_vars+20
.alias dict_which				user_vars+22
.alias no_print					user_vars+24
.alias eoc						user_vars+26
.alias chartable				user_vars+28
.alias debug_xt					user_vars+30
.alias debug_address			user_vars+31
...
;.alias current_offset 1    		; CURRENT (byte) : UP + 4 (Compilation wordlist)
;.alias num_wordlists_offset 2	; #WORDLISTS (byte) : UP + 5
;.alias wordlists_offset 3  		; WORDLISTS (cells) : UP + 6 to UP + 29
;								;          (FORTH, EDITOR, ASSEMBLER, ROOT, +8 more)
