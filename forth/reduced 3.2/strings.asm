...
s_wid_asm:    .byte 0  				; Wordlist ID 2, note space at end
s_wid_editor: .byte 0     			; Wordlist ID 1, note space at end
s_wid_forth:  .byte 0      			; Wordlist ID 0, note space at end
s_wid_root:   .byte 0       		; Wordlist ID 3, note space at end
